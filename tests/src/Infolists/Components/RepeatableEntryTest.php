...
describe('relationships', function (): void {
    it('can rebuild items when a loaded relationship `Collection` is mutated in place', function (): void {
        $user = User::factory()
        ...
        expect($entry->getState())->toHaveCount(1)
            ->and($entry->getItems())->toHaveCount(1);
    });
