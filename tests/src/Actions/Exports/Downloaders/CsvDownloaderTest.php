...
use Filament\Actions\Exports\Downloaders\CsvExportContent;
...
it('yields the CSV header and data chunks from `CsvExportContent`', function (): void {
    Storage::fake('local');
    ...
    expect(iterator_to_array(app(CsvExportContent::class)($export)))->toBe([
        "id,name\n",
        "1,Alpha\n",
        "2,Beta\n",
    ]);
