...
<AutoScreenshot name="panels/dashboard" alt="Dashboard with widgets" version="6.x" />
...
<AutoScreenshot name="panels/dashboard-column-spans" alt="Dashboard with customized widget column spans" version="6.x" />
...
<AutoScreenshot name="panels/dashboard-filters" alt="Dashboard with filter form" version="6.x" />
...
<AutoScreenshot name="panels/dashboard-filter-action" alt="Dashboard with filter action modal" version="6.x" />
