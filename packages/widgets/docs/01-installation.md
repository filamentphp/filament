...
**The Widgets package is pre-installed with the [Panel Builder](../panels).** This guide is for using the Widgets package in a custom TALL Stack application (Tailwind, Alpine, Livewire, Laravel).
