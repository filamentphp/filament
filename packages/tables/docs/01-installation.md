...
```bash
npm install alpinejs @alpinejs/trap tailwindcss@latest postcss@latest autoprefixer@latest @tailwindcss/forms@latest @tailwindcss/typography@latest --save-dev
```
