...
The table builder comes pre-installed inside the [admin panel 2.x](../admin/installation), but you must still follow the installation instructions below if you're using it in the rest of your app.
