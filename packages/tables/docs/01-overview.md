...
<AutoScreenshot name="tables/example" alt="Table" version="6.x" />
...
<AutoScreenshot name="tables/overview/columns" alt="Table with columns" version="6.x" />
...
<AutoScreenshot name="tables/overview/searchable-columns" alt="Table with searchable column" version="6.x" />
...
<AutoScreenshot name="tables/overview/sortable-columns" alt="Table with sortable column" version="6.x" />
...
<AutoScreenshot name="tables/overview/relationship-columns" alt="Table with relationship column" version="6.x" />
...
<AutoScreenshot name="tables/overview/filters" alt="Table with filters" version="6.x" />
...
<AutoScreenshot name="tables/overview/actions" alt="Table with actions" version="6.x" />
...
<AutoScreenshot name="tables/overview/actions-modal" alt="Table with action modal open" version="6.x" />
...
<AutoScreenshot name="tables/pagination/default" alt="Table with default pagination" version="6.x" />
...
### Disabling records per page persistence in the user's session

By default, the selected number of records per page is persisted in the user's session. To disable this behavior, use the `persistRecordsPerPageInSession()` method:
...
<AutoScreenshot name="tables/pagination/extreme" alt="Table with extreme pagination links" version="6.x" />
...
<AutoScreenshot name="tables/pagination/simple" alt="Table with simple pagination" version="6.x" />
...
<AutoScreenshot name="tables/pagination/cursor" alt="Table with cursor pagination" version="6.x" />
...
<AutoScreenshot name="tables/reordering" alt="Table with reorderable rows" version="6.x" />
...
<AutoScreenshot name="tables/reordering/custom-trigger-action" alt="Table with reorderable rows and a custom trigger action" version="6.x" />
...
<AutoScreenshot name="tables/heading" alt="Table with heading and description" version="6.x" />
...
Filament can remember a table's [filters](filters#persisting-filters-in-the-users-session), [search](columns#persisting-the-search-in-the-users-session), [sort](columns#persisting-the-sort-in-the-users-session), [grouping](grouping#persisting-the-grouping-in-the-users-session), [column manager](columns#disabling-column-persistence-in-the-users-session), and [records per page](#disabling-records-per-page-persistence-in-the-users-session) state in the user's session, so it is restored when they return to the table. Each feature has its own method, but you can toggle all of them at once using the `persistInSession()` method:
...
<AutoScreenshot name="tables/striped" alt="Table with striped rows" version="6.x" />
...
<AutoScreenshot name="tables/custom-row-classes" alt="Table with custom row classes" version="6.x" />
