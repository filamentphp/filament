                ...
                <x-tables::table>
                    <x-slot name="header">
                        ...
                        @foreach ($columns as $column)
                            <x-tables::header-cell
                                ...
                                class="filament-table-cell-{{ Str::of($column->getName())->camel()->kebab() }} {{ $getHiddenClasses($column) }}"
                            >
                                {{ $column->getLabel() }}
                            </x-tables::header-cell>
                        @endforeach
                    ...
                    @if ($isColumnSearchVisible)
                        <x-tables::row>
                            ...
                            @foreach ($columns as $column)
                                <x-tables::cell class="filament-table-cell-{{ Str::of($column->getName())->camel()->kebab() }} px-4 py-1" >
