...
<div {{ $attributes->class(['flex flex-1 flex-col items-center justify-center p-6 mx-auto space-y-6 text-center bg-white dark:bg-dark-800', 'filament-tables-empty-state']) }}>
