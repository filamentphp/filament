...
<div class="flex shadow-sm">
    @if ($this->isActionable())
        <select wire:model="action" class="flex-shrink-0 text-sm border-gray-300 rounded sm:text-base focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
