...
<div {{ $attributes->class(['filament-tables-search-input']) }}>
    ...
    <div class="relative group">
        ...
        <input
            ...
            autocomplete="off"
            @class([
                'block h-9 w-full max-w-xs rounded-lg border-gray-300 pl-9 placeholder-gray-400 shadow-sm transition duration-75 focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 sm:text-sm',
