...
<div {{ $attributes->class(['filament-tables-search-input']) }}>
    ...
    <div class="relative group">
        ...
        <input
            ...
            type="search"
            autocomplete="off"
            class="block w-full max-w-xs h-9 pl-9 placeholder-gray-400 transition duration-75 border-gray-300 rounded-lg shadow-sm sm:text-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
        >
    </div>
</div>
