...
<div {{ $attributes->class(['filament-tables-search-input']) }}>
    ...
    <div class="relative group">
        ...
        <input
            ...
            autocomplete="off"
            @class([
                'block w-full h-9 pl-9 placeholder-gray-400 transition duration-75 border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
