...
>
    ...
    <span @class(['dark:text-white' => config('filament-tables.dark_mode')]) x-text="window.pluralize(@js(__('filament-tables::table.selection_indicator.selected_count')), selectedRecords.length, { count: selectedRecords.length })"></span>
