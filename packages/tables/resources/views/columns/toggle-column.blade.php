...
>
    ...
    <button
        ...
        wire:ignore.self
        type="button"
        class="relative inline-flex shrink-0 ms-4 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 outline-none focus:ring-1 focus:ring-offset-1 focus:ring-primary-500 disabled:opacity-70 disabled:cursor-not-allowed disabled:pointer-events-none"
    >
        <span
