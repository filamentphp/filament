...
<AutoScreenshot name="actions/edit-action/modal" alt="Edit action modal" version="6.x" />
...
<UtilityInjection set="actions" version="6.x">As well as `$data`, the `mutateRecordDataUsing()` function can inject various utilities as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as `$record` and `$data`, the `using()` function can inject various utilities as parameters.</UtilityInjection>
