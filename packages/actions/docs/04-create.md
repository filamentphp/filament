...
<AutoScreenshot name="actions/create-action/modal" alt="Create action modal" version="6.x" />
...
<UtilityInjection set="actions" version="6.x">As well as `$data`, the `mutateDataUsing()` function can inject various utilities as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as `$data` and `$model`, the `using()` function can inject various utilities as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as `$record`, the `successRedirectUrl()` function can inject various utilities as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as allowing a static value, the `successNotificationTitle()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">These hook functions can inject various utilities as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as allowing a static value, the `createAnother()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>
...
<UtilityInjection set="actions" version="6.x">As well as allowing a static value, the `preserveFormDataWhenCreatingAnother()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>
