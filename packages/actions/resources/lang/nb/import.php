...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} Filen kan ikke inneholde mer enn én tom kolonneoverskrift.|{1,*} Filen kan ikke inneholde like kolonneoverskrifter: :columns.',
                ],
            ],
    ...
    'failure_csv' => [
        ...
        'column_mapping_required_for_new_record' => ':attribute kolonnen var ikke knyttet til en kolonne i filen, men dette er påkrevd for å opprette nye data.',
    ],
