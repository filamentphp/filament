...
trait CanBeHidden
{
    ...
    {
        $this->hidden(static function (HasInfolists $livewire, string $operation) use ($operations): bool {
    ...
    {
        $this->visible(static function (string $operation, HasInfolists $livewire) use ($operations): bool {
