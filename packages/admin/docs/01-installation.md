...
This package is compatible with other Filament v2.x products. The [form builder](../forms/installation), [table builder](../tables/installation) and [notifications](../notifications/installation) come pre-installed with the package, and no other installation steps are required to use them within the admin panel.
