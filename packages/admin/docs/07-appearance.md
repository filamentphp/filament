...
- `scripts.before` - before scripts are defined
- `scripts.after` - after scripts are defined
- `styles.before` - before styles are defined
- `styles.after` - after styles are defined
