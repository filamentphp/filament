@if(config('filament.layout.darkmode'))
    <div class="flex justify-center">
        <button x-show="theme === 'dark'" @click="theme = 'system'">
        ...
        <button x-show="theme === 'light'" @click="theme = 'dark'" x-cloak>
        ...
        <button x-show="theme === 'system'" @click="window.matchMedia('(prefers-color-scheme: dark)').matches ? theme = 'light' : theme = 'dark'" x-cloak>
