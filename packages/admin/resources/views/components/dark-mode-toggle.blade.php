@if (config('filament.layout.dark_mode'))
    <div x-text="$store.darkMode.isEnabled"></div>

    <div x-cloak class="flex justify-center">
        <button x-show="$store.darkMode.isEnabled" @click="$store.darkMode.isEnabled = null">
        ...
        <button x-show="$store.darkMode.isEnabled === false" @click="$store.darkMode.isEnabled = true" x-cloak>
        ...
        <button x-show="$store.darkMode.isEnabled === null" @click="window.matchMedia('(prefers-color-scheme: dark)').matches ? $store.darkMode.isEnabled = false : $store.darkMode.isEnabled = true" x-cloak>
