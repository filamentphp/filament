<aside
    ...
    class="fixed inset-y-0 ltr:left-0 rtl:right-0 z-20 flex flex-col h-screen overflow-hidden shadow-2xl transition duration-300 bg-white lg:border-r w-80 lg:z-0 lg:translate-x-0"
>
