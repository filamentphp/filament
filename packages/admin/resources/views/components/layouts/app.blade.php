...
<x-filament::layouts.base :title="$title">
    <div class="flex w-full min-h-screen overflow-x-hidden filament-app-layout">
        ...
        <div
            ...
            @endif
            @class([
                'flex-col w-screen gap-y-6 rtl:lg:pl-0 filament-main',
                'flex-1 hidden h-full transition-all' => config('filament.layout.sidebar.is_collapsible_on_desktop'),
                'flex flex-1 lg:pl-[var(--sidebar-width)] rtl:lg:pr-[var(--sidebar-width)]' => ! config('filament.layout.sidebar.is_collapsible_on_desktop'),
            ])
        >
            <header @class([
