...
@php
    list($color, $format) = explode('-', $color) + ['primary', 'default'];
    $buttonClasses = array_merge([
        'dark:focus:ring-offset-0' => config('filament.dark_mode'),
        'inline-flex items-center justify-center font-medium tracking-tight rounded-lg border transition-colors filament-button',
        ...
        'text' => [
            'underline-offset-1 hover:underline focus:underline focus:ring-inset border-transparent',
            ...
            'dark:text-primary-500' => $color === 'primary' && config('filament.dark_mode'),
            'dark:text-success-500' => $color === 'success' && config('filament.dark_mode'),
            'dark:text-danger-500' => $color === 'danger' && config('filament.dark_mode'),
            'dark:text-warning-500' => $color === 'warning' && config('filament.dark_mode'),
            'dark:text-gray-400' => $color === 'gray' && config('filament.dark_mode'),
            'dark:text-gray-200' => $color === 'secondary' && config('filament.dark_mode'),
        ],
    ][$format]);
