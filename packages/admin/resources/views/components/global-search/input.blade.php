<div {{ $attributes->class(['filament-global-search-input']) }}>
    ...
    <div class="relative group max-w-md">
        <span @class([
            'absolute inset-y-0 start-0 flex items-center justify-center w-10 h-10 text-gray-500 pointer-events-none group-focus-within:text-primary-500',
        ...
        <input
            ...
            autocomplete="off"
            @class([
                'block w-full h-10 ps-10 bg-gray-400/10 placeholder-gray-500 border-transparent transition duration-75 rounded-lg outline-none focus:bg-white focus:placeholder-gray-400 focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
