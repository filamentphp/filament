  ...
  */
  ...
  var require_mousetrap = __commonJS((exports, module) => {
    (function(window2, document2, undefined2) {
      ...
      function Mousetrap3(targetElement) {
        ...
        function _getMatches(character, modifiers, e, sequenceName, combination, level) {
          ...
          for (i2 = 0; i2 < self._callbacks[character].length; ++i2) {
            callback2 = self._callbacks[character][i2];
            ...
            if (action == "keypress" && !e.metaKey && !e.ctrlKey || _modifiersMatch(modifiers, callback2.modifiers)) {
              ...
              matches2.push(callback2);
            }
          }
          return matches2;
        }
        function _fireCallback(callback2, e, combo, sequence) {
          if (self.stopCallback(e, e.target || e.srcElement, combo, sequence)) {
            return;
          }
          if (callback2(e, combo) === false) {
            _preventDefault(e);
            _stopPropagation(e);
          }
        }
        ...
        function _bindSequence(combo, keys, callback2, action) {
          ...
          function _callbackAndReset(e) {
            _fireCallback(callback2, e, combo);
            if (action !== "keyup") {
        ...
        function _bindSingle(combination, callback2, action, sequenceName, level) {
          self._directMap[combination + ":" + action] = callback2;
        ...
        self._bindMultiple = function(combinations, callback2, action) {
          for (var i2 = 0; i2 < combinations.length; ++i2) {
            _bindSingle(combinations[i2], callback2, action);
          }
        };
      ...
      Mousetrap3.prototype.bind = function(keys, callback2, action) {
        var self = this;
        keys = keys instanceof Array ? keys : [keys];
        self._bindMultiple.call(self, keys, callback2, action);
        return self;
      };
  ...
  (function(Mousetrap3) {
    ...
    Mousetrap3.prototype.bindGlobal = function(keys, callback2, action) {
      var self = this;
      self.bind(keys, callback2, action);
  ...
  var __commonJS2 = (callback2, module) => () => {
    if (!module) {
      module = {exports: {}};
      callback2(module.exports, module);
    }
    ...
    function mapToStyles(_ref2) {
      ...
      if (adaptive) {
        ...
        if (offsetParent === getWindow(popper2)) {
          ...
          if (getComputedStyle3(offsetParent).position !== "static") {
  ...
  var require_tippy_cjs = __commonJS2((exports) => {
    ...
    function tippy2(targets, optionalProps) {
      ...
      var instances2 = elements2.reduce(function(acc, reference) {
    ...
    var createSingleton = function createSingleton2(tippyInstances, optionalProps) {
      ...
      var references = [];
      var currentTarget;
      var overrides2 = optionalProps.overrides;
      ...
      function prepareInstance(singleton2, target) {
        ...
        var overrideProps = (overrides2 || []).concat("content").reduce(function(acc, prop) {
      ...
      singleton.setProps = function(props) {
        overrides2 = props.overrides || overrides2;
  ...
  document.addEventListener("alpine:init", () => {
    ...
    window.Alpine.plugin(module_default5);
    window.Alpine.store("sidebar", {
      ...
      toggleCollapsedGroup: function(group) {
        this.collapsedGroups = this.collapsedGroups.includes(group) ? this.collapsedGroups.filter((collapsedGroup) => collapsedGroup !== group) : this.collapsedGroups.concat(group);
      },
      close: function() {
        this.isOpen = false;
      },
  ...
  auto_default.defaults.font.family = `'DM Sans', sans-serif`;
