        ...
        >
            <div
                ...
                @class([
                    ...
                    'hidden' => ! $visible,
                    match ($width) {
                        'xs', \Filament\Support\Enums\ModalWidth::ExtraSmall => 'max-w-xs',
                        'sm', \Filament\Support\Enums\ModalWidth::Small => 'max-w-sm',
                        'md', \Filament\Support\Enums\ModalWidth::Medium => 'max-w-md',
                        'lg', \Filament\Support\Enums\ModalWidth::Large => 'max-w-lg',
                        'xl', \Filament\Support\Enums\ModalWidth::ExtraLarge => 'max-w-xl',
                        '2xl', \Filament\Support\Enums\ModalWidth::TwoXl => 'max-w-2xl',
                        '3xl', \Filament\Support\Enums\ModalWidth::ThreeXl => 'max-w-3xl',
                        '4xl', \Filament\Support\Enums\ModalWidth::FourXl => 'max-w-4xl',
                        '5xl', \Filament\Support\Enums\ModalWidth::FiveXl => 'max-w-5xl',
                        '6xl', \Filament\Support\Enums\ModalWidth::SixXl => 'max-w-6xl',
                        '7xl', \Filament\Support\Enums\ModalWidth::SevenXl => 'max-w-7xl',
                        'screen', \Filament\Support\Enums\ModalWidth::Screen => 'fixed inset-0',
                        default => $width,
                    },
                ])
            >
