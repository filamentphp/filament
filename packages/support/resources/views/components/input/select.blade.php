...
<select
    {{
        $attributes->class([
            'filament-select-input block text-gray-950 shadow-sm outline-none transition duration-75 focus:ring-1 focus:ring-inset disabled:opacity-70 dark:bg-gray-700 dark:text-white sm:text-sm',
            'h-9 py-1' => $size === 'sm',
