...
@php
    ...
    $enabledWrapperClasses = 'bg-white [&:not(:has(.fi-ac-action:focus))]:focus-within:ring-2 dark:bg-white/5';
    ...
    $enabledValidWrapperClasses = '[&:not(:has(.fi-ac-action:focus))]:focus-within:ring-primary-600 dark:ring-white/20 dark:[&:not(:has(.fi-ac-action:focus))]:focus-within:ring-primary-500';
