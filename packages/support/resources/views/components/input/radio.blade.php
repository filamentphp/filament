    ...
    {{
        $attributes
            ->class([
                ...
                'text-primary-600 focus:ring-primary-600 checked:focus:ring-primary-500/50 dark:text-primary-500 dark:checked:bg-primary-500 dark:focus:ring-primary-500 dark:checked:focus:ring-primary-400/50 ring-gray-950/10 dark:ring-white/20 dark:disabled:ring-white/10' => $valid,
