...
@php
    ...
    if ($hasLoadingIndicator) {
        $loadingIndicatorTarget = \Illuminate\Support\Str::before(html_entity_decode(html_entity_decode($attributes->get('wire:target', $attributes->get('wire:click')), ENT_QUOTES), '(');
    }
@endphp
