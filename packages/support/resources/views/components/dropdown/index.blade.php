...
>
    ...
    <div
        x-cloak
        x-float{{ $placement ? ".placement.{$placement}" : '' }}.autoPlacement{{ $shift ? '.shift' : '' }}{{ $teleport ? '.teleport' : '' }}{{ $offset ? '.offset' : '' }}="{ offset: {{ $offset }},autoPlacement:{allowedPlacements: ['top', 'bottom']} }"
        x-ref="panel"
