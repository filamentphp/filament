...
>
    ...
    <div
        ...
        @endif
        @class([
            'filament-dropdown-panel absolute z-10 max-h-[var(--dropdown-panel-max-height)] w-full divide-y divide-gray-100 overflow-y-auto rounded-lg bg-white shadow-lg ring-1 ring-black/5 transition',
