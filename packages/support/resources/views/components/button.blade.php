...
@php
    ...
    $iconClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        'w-6 h-6' => $size === 'lg',
        'w-7 h-7' => $size === 'xl',
        'mr-1 -ml-0.5 rtl:ml-1 rtl:-mr-0.5' => ($iconPosition === 'before') && ($size === 'xs') && (! $labelSrOnly),
        ...
        'mr-2 -ml-3 rtl:ml-2 rtl:-mr-3' => ($iconPosition === 'before') && ($size === 'lg' || $size === 'xl') && (! $labelSrOnly),
        'ml-1 -mr-0.5 rtl:mr-1 rtl:-ml-0.5' => ($iconPosition === 'after') && ($size === 'xs') && (! $labelSrOnly),
        ...
        'ml-2 -mr-3 rtl:mr-2 rtl:-ml-3' => ($iconPosition === 'after') && ($size === 'lg' || $size === 'xl') && (! $labelSrOnly),
    ]);
