...
@php
    ...
    $badgeContainerClasses = 'fi-link-badge-ctn absolute start-full top-0 z-[1] w-max -translate-x-1/4 -translate-y-3/4 rounded-md bg-white rtl:translate-x-1/4 dark:bg-gray-900';
