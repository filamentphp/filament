...
The `$navigationIcon` property supports the name of any Blade component. By default, the [Blade Heroicons v2](https://github.com/tailwindlabs/heroicons) package is installed, so you may use the name of any [Heroicons v2](https://heroicons.com) out of the box. However, you may create your own custom icon components or install an alternative library if you wish.
