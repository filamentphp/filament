...
If you set `$navigationIcon = null` on multiple resources within the same navigation Group, those items will be joined with a vertical bar below the Group name.
