...
return [
    ...
    'messages' => [
        'notification_not_received' => 'Нисите примили е-пошту коју смо послали?',
        'notification_sent' => 'Послали смо е-пошту на :email са упуством о томе како потврдити своју адресу е-поште.',
    ],
