...
return [
    ...
    'modal' => [
        ...
        'content' => [
            ...
            'text_code' => [
                'instruction' => 'ឬបញ្ចូលកូដនេះដោយដៃ៖',
                'messages' => [
                    'copied' => 'បានចម្លង',
                ],
            ],
            ...
            'recovery_codes' => [
                'instruction' => 'សូមរក្សាទុកកូដសង្គ្រោះខាងក្រោមក្នុងកន្លែងដែលមានសុវត្ថិភាព។ ពួកវានឹងត្រូវបានបង្ហាញតែម្តងគត់ ប៉ុន្តែអ្នកនឹងត្រូវការវាប្រសិនបើអ្នកបាត់បង់ការចូលប្រើកម្មវិធីផ្ទៀងផ្ទាត់របស់អ្នក៖',
            ],
        ...
        'form' => [
            ...
            'code' => [
                ...
                'below_content' => 'អ្នកនឹងត្រូវបញ្ចូលកូដ ៦ ខ្ទង់ពីកម្មវិធីផ្ទៀងផ្ទាត់របស់អ្នករាល់ពេលដែលអ្នកចូល ឬអនុវត្តសកម្មភាពរសើប។',
                'messages' => [
        ...
        'actions' => [
            'submit' => [
                'label' => 'បើកដំណើរការកម្មវិធីផ្ទៀងផ្ទាត់',
            ],
        ],
    ...
    'notifications' => [
        'enabled' => [
            'title' => 'កម្មវិធីផ្ទៀងផ្ទាត់ត្រូវបានបើកដំណើរការហើយ',
        ],
    ],
