...
return [
    ...
    'modal' => [
        ...
        'description' => <<<'BLADE'
            Necessitaras una aplicació com Google Authenticator (<x-filament::link href="https://itunes.apple.com/us/app/google-authenticator/id388497605" target="_blank">iOS</x-filament::link>, <x-filament::link href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" target="_blank">Android</x-filament::link>) per completar aquest procés.
            BLADE,
        ...
        'form' => [
            ...
            'code' => [
                ...
                'below_content' => 'Necesitaràs introduir el codi de 6 dígito de la teva aplicació d\'autenticació cada vegada que inciis sessió o realitzis accions sensibles.',
    ...
    'notifications' => [
        ...
        'enabled' => [
            'title' => 'L\'aplicació d\'autenticació ha sigut habilitada',
        ],
