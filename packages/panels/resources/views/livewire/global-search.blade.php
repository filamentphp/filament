        ...
        <div x-id="['input']" class="fi-global-search-field">
            ...
            >
                <input
                    ...
                    x-mousetrap.global.{{ collect($keyBindings)->map(fn (string $keyBinding): string => str_replace('+', '-', $keyBinding))->implode('.') }}="($el.checkVisibility?.() ?? true) && document.getElementById($id('input'))?.focus()"
