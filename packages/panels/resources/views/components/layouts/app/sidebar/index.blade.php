...
<aside
    ...
    @endif
    @class([
        'filament-sidebar fixed inset-y-0 start-0 z-20 flex h-screen w-[--sidebar-width] flex-col bg-white transition-all dark:bg-gray-800 lg:z-0 lg:bg-transparent',
...
>
    <header
        class="filament-sidebar-header relative flex h-[4rem] shrink-0 items-center justify-center bg-white shadow-[0_1px_0_0_theme(colors.gray.950_/_5%)] dark:shadow-[0_1px_0_0_theme(colors.white_/_20%)]"
    >
        <div
            @class([
    ...
    <nav
        class="filament-sidebar-nav flex-1 overflow-y-auto overflow-x-hidden py-6 shadow-[1px_0_0_0_theme(colors.gray.950_/_5%)] dark:shadow-[1px_0_0_0_theme(colors.white_/_20%)] lg:shadow-none"
    >
