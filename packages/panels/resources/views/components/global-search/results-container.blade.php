...
<div
    ...
    {{ $attributes->class(['fi-global-search-results-cnt absolute end-0 top-auto z-10 mt-2 w-screen max-w-xs overflow-hidden rounded-xl shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10 sm:max-w-lg']) }}
>
