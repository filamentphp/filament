...
<div
    ...
    {{
        $attributes->class([
            'fi-global-search-results-ctn absolute start-0 sm:start-auto sm:end-0 z-10 mt-2 max-h-96 w-full sm:w-screen sm:max-w-sm overflow-auto rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 transition dark:bg-gray-900 dark:ring-white/10',
        ])
    }}
>
