...
>
    <a
        ...
        @endif
        @class([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-3 rounded-lg px-2 py-2 outline-none transition duration-75 [&:link]:hover:bg-gray-100 [&:link]:focus-visible:bg-gray-100 dark:[&:link]:hover:bg-white/5 dark:[&:link]:focus-visible:bg-white/5',
