 ...
 * @method static void globalSearchProvider(string $provider, ?string $context = null)
 ...
 * @method static void navigation(Closure $builder, ?string $context = null)
 * @method static void registerContext(Context $context)
 * @method static void registerNavigationGroups(array $groups, ?string $context = null)
 * @method static void registerNavigationItems(array $items, ?string $context = null)
 * @method static void registerPages(array $pages, ?string $context = null)
 * @method static void registerRenderHook(string $name, Closure $callback, ?string $context = null)
 * @method static void registerResources(array $resources, ?string $context = null)
 * @method static void registerTenantMenuItems(array $items, ?string $context = null)
 * @method static void registerTheme(string | Htmlable | null $theme, ?string $context = null)
 * @method static void registerUserMenuItems(array $items, ?string $context = null)
 * @method static void registerWidgets(array $widgets, ?string $context = null)
