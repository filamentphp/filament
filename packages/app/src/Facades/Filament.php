 ...
 * @method static string | null getTenantBillingUrl(array<mixed> $parameters = [], Model | null $tenant = null)
 ...
 * @method static string | null getTenantRegistrationUrl(array<mixed> $parameters = [])
