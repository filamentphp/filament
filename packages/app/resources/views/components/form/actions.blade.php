...
@if (count($actions))
    <div
        @if ($this->areFormActionsSticky())
            ...
            x-bind:class="{
                'filament-form-actions-sticky-panel sticky bottom-0 -mx-4 transform bg-white p-4 shadow-lg transition ring-1 ring-gray-900/5 md:-translate-y-4 md:rounded-xl dark:bg-gray-800 dark:ring-white/20': isSticky,
            }"
        @endif
    >
