...
<div
    ...
    {{ $attributes->class(['filament-global-search-results-container absolute end-0 top-auto z-10 mt-2 w-screen max-w-xs overflow-hidden rounded-xl shadow-xl ring-1 ring-gray-900/5 dark:ring-white/20 sm:max-w-lg']) }}
>
