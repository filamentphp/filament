    ...
    return {
        ...
        init() {
            this.select = new Select({
                ...
                getOptionLabelUsing: () => this.$getOptionLabel(),
                getOptionLabelsUsing: () => this.$getOptionLabelsForJs(),
                getOptionsUsing: () => this.$getOptionsForJs(),
                getSearchResultsUsing: (search) =>
                    this.$getSearchResultsForJs({ search }),
                hasDynamicOptions,
                hasDynamicSearchResults,
                hasInitialNoOptionsMessage,
                id,
