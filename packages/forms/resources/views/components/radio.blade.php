                            ...
                            {{
                                $getExtraInputAttributeBag()
                                    ->class([
                                        ...
                                        'text-primary-600 ring-gray-950/10 focus:ring-primary-600 checked:focus:ring-primary-600/50 dark:ring-white/20 dark:checked:bg-primary-500 dark:focus:ring-primary-500 dark:checked:focus:ring-primary-500/50 dark:disabled:ring-white/10' => ! $errors->has($statePath),
