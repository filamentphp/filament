...
>
    <div class="flex space-x-3">
        ...
        @if ($isCollapsible())
            ...
            >
                <svg class="h-7 w-7 transform-gpu duration-150" x-bind:class="!isCollapsed ? ' -rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
