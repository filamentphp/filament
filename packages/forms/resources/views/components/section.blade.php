<div
    ...
    @endif
    id="{{ $getId() }}"
    {{ $attributes->merge($getExtraAttributes())->class(['p-6 space-y-6 rounded-xl shadow-sm border border-gray-300 dark:border-gray-600', 'filament-forms-section-component']) }}
