    ...
    >
        @unless ($isDisabled())
            ...
            <trix-editor
                ...
                x-ref="trix"
                @class([
                    'bg-white block w-full transition duration-75 rounded-lg shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-600 prose max-w-none dark:bg-dark-700 dark:text-dark-200',
