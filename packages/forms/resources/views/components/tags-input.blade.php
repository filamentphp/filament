...
>
    ...
    >
        <div
            ...
            @class([
                'block w-full duration-75 divide-y rounded shadow-sm border overflow-hidden focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-primary-600',
