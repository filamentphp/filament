...
>
    ...
    >
        <div
            ...
            @class([
                'block w-full transition duration-75 divide-y rounded-lg shadow-sm sm:text-sm border overflow-hidden outline-none focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:divide-gray-600',
