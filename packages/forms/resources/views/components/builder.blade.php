            ...
            >
                ...
                <x-filament-support::grid
                    ...
                    :class="\Illuminate\Support\Arr::toCssClasses([
                        'gap-12' => (! $isItemCreationDisabled) && (! $isItemMovementDisabled),
                        'gap-6' => $isItemCreationDisabled || $isItemMovementDisabled,
                    ])"
                >
                    @foreach ($containers as $uuid => $item)
                        ...
                        <x-filament-support::grid.column
                            :default="$block->getColumnSpan('default')"
                            :sm="$block->getColumnSpan('sm')"
                            :md="$block->getColumnSpan('md')"
                            :lg="$block->getColumnSpan('lg')"
                            :xl="$block->getColumnSpan('xl')"
                            :twoXl="$block->getColumnSpan('2xl')"
                        >
                            <li
                                x-data="{
