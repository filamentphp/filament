<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    @if ($isDisabled())
        <div
            class="prose block w-full max-w-none rounded-lg bg-gray-50 px-3 py-3 text-gray-500 shadow-sm ring-1 ring-gray-950/10 dark:prose-invert dark:bg-transparent dark:text-gray-400 dark:ring-white/20 sm:text-sm"
        >
