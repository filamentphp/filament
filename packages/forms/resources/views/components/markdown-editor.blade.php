                ...
                <file-attachment directory>
                    <textarea
                        ...
                        x-bind:class="{
                            ...
                            'dark:border-gray-600': ! (@js($getStatePath()) in $store.errors.entries) && @js(config('forms.dark_mode')),
                            'border-danger-600 ring-danger-600': @js($getStatePath()) in $store.errors.entries,
                        }"
                    ></textarea>
                </file-attachment>
