            ...
            <div class="flex items-stretch justify-between h-8">
                <markdown-toolbar for="{{ $formComponent->getId() }}" class="flex items-stretch space-x-4">
                    <div class="flex items-stretch space-x-1">
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getBoldLabel()) }}">
                            <md-bold>
                        ...
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getItalicLabel()) }}">
                            <md-italic>
                        ...
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getStrikethroughLabel()) }}">
                            <md-strikethrough>
                    ...
                    <div class="flex items-stretch space-x-1">
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getUrlLabel()) }}">
                            <md-link class="w-full h-full">
                                <x-heroicon-o-link class="w-4" />
                            </md-link>
                        </x-filament::button>
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getImageLabel()) }}">
                            <md-image class="w-full h-full">
                                <x-heroicon-o-photograph class="w-4" />
                            </md-image>
                        </x-filament::button>
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getCodeLabel()) }}">
                    ...
                    <div class="flex items-stretch space-x-1">
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getUnorderedListLabel()) }}">
                        ...
                        <x-filament::button size="small" class="text-base" title="{{ __($formComponent->getOrderedListLabel()) }}">
