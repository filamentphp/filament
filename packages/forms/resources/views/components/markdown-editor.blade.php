    ...
    >
        <div class="space-y-2">
                                ...
                                @if ($hasToolbarButton('bold'))
                                    ...
                                    >
                                        <md-bold>
                                            <svg @class([
                                                'h-4',
                                                'dark:fill-current' => config('filament-forms.dark_mode'),
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            @if ($hasToolbarButton('edit'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-gray-400 @if (config('filament-forms.dark_mode')) dark:text-gray-400 @endif': tab !== 'edit' }"
                            ...
                            @if ($hasToolbarButton('preview'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-gray-400 @if (config('filament-forms.dark_mode')) dark:text-gray-400 @endif': tab !== 'preview' }"
                                    @class([
                                        'text-sm hover:underline',
                                        'text-gray-400' . (config('filament-forms.dark_mode') ? ' dark:text-gray-400' : null),
                                    ])
                                >
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        x-bind:class="{
                            'dark:caret-white dark:focus:border-primary-500': @js(config('filament-forms.dark_mode')),
                            'border-gray-300': ! (@js($getStatePath()) in $wire.__instance.serverMemo.errors),
                            'dark:border-gray-600': ! (@js($getStatePath()) in $wire.__instance.serverMemo.errors) && @js(config('filament-forms.dark_mode')),
                ...
                <div
                    ...
                    @class([
                        ...
                        'dark:bg-gray-700 dark:border-gray-600 dark:text-white' => config('filament-forms.dark_mode'),
                    ])
                ></div>
            </div>
            ...
            <div @class([
                ...
                'dark:prose-invert dark:border-gray-600 dark:bg-gray-700' => config('filament-forms.dark_mode'),
