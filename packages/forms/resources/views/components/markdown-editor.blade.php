                        ...
                        @if ($hasToolbarButton(['bold', 'italic', 'strike']))
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                @if ($hasToolbarButton('bold'))
                                    ...
                                    >
                                        <md-bold class="dark:text-white">
                                            <svg class="w-4 dark:fill-current" viewBox="0 0 16 16" version="1.1" aria-hidden="true"><path fill-rule="evenodd" d="M4 2a1 1 0 00-1 1v10a1 1 0 001 1h5.5a3.5 3.5 0 001.852-6.47A3.5 3.5 0 008.5 2H4zm4.5 5a1.5 1.5 0 100-3H5v3h3.5zM5 9v3h4.5a1.5 1.5 0 000-3H5z"></path></svg>
                                        </md-bold>
                                    </x-forms::markdown-editor.toolbar-button>
                                @endif
                                ...
                                @if ($hasToolbarButton('italic'))
                                    ...
                                    >
                                        <md-italic>
                                            <svg class="w-4 dark:fill-current" height="16" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true"><path fill-rule="evenodd" d="M6 2.75A.75.75 0 016.75 2h6.5a.75.75 0 010 1.5h-2.505l-3.858 9H9.25a.75.75 0 010 1.5h-6.5a.75.75 0 010-1.5h2.505l3.858-9H6.75A.75.75 0 016 2.75z"></path></svg>
                                        </md-italic>
                                    </x-forms::markdown-editor.toolbar-button>
                                @endif
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            @if ($hasToolbarButton('edit'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-gray-400 dark:text-slate-400': tab !== 'edit' }"
                            ...
                            @if ($hasToolbarButton('preview'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-gray-400 dark:text-slate-400': tab !== 'preview' }"
                                    class="text-sm hover:underline"
                                >
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        @class([
                            'tracking-normal whitespace-pre-wrap overflow-y-hidden font-mono block absolute bg-transparent top-0 text-sm left-0 block z-1 w-full h-full min-h-full resize-none transition duration-75 rounded-lg shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-600 caret-black dark:caret-white',
