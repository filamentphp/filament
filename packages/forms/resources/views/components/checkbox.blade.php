        ...
        <input
            {{
                $attributes
                    ...
                    ->class([
                        'filament-forms-checkbox-component rounded text-primary-600 shadow-sm transition duration-75 focus:ring-2 disabled:opacity-70 dark:bg-gray-700 dark:checked:bg-primary-500',
