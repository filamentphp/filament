...
<div
    ...
    x-transition
    {{ $attributes->class(['absolute z-10 mt-10 shadow-xl border overflow-hidden rounded-xl w-52 dark:border-dark-600', 'filament-forms-builder-component-block-picker']) }}
>
