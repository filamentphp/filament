...
<div
    ...
    x-transition
    {{ $attributes->class(['absolute z-10 mt-10 shadow-xl border overflow-hidden rounded-xl w-52 dark:border-gray-600', 'filament-forms-builder-component-block-picker']) }}
>
    <ul class="py-1 space-y-1 bg-white shadow rounded-xl dark:bg-gray-700 dark:divide-gray-600">
