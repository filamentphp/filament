                            ...
                            @if ((! $isItemMovementDisabled) || (! $isItemDeletionDisabled) || $isCloneable || $isCollapsible || $hasItemLabels)
                                ...
                                >
                                    @unless ($isItemMovementDisabled)
                                        <button
                                            x-tooltip="'{{ __('forms::components.repeater.buttons.move_item.tooltip') }}'"
                                            x-on:click.stop
                                    ...
                                    <ul @class([
                                        ...
                                        @if ($isCloneable)
                                            <li>
                                                <button
                                                    x-tooltip="'{{ __('forms::components.repeater.buttons.clone_item.tooltip') }}'"
                                        ...
                                        @unless ($isItemDeletionDisabled)
                                            <li>
                                                <button
                                                    x-tooltip="'{{ __('forms::components.repeater.buttons.delete_item.tooltip') }}'"
                                        ...
                                        @if ($isCollapsible)
                                            <li>
                                                <button
                                                    x-tooltip="!isCollapsed ? '{{ __('forms::components.repeater.buttons.collapse_item.tooltip') }}' : '{{ __('forms::components.repeater.buttons.expand_item.tooltip') }}'"
