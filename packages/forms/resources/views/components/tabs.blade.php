    ...
    >
        @foreach ($getChildComponentContainer()->getComponents() as $tab)
            <button
                ...
                x-bind:class="{
                    'text-gray-500 hover:text-gray-800 focus:text-primary-600 @if (config('forms.dark_mode')) dark:text-gray-400 dark:hover:text-gray-300 dark:focus:text-primary-400 @endif': tab !== '{{ $tab->getId() }}',
