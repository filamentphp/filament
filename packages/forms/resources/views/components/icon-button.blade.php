...
@php
    $buttonClasses = [
        'flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-500/5 focus:outline-none filament-forms-icon-button',
    ...
    $iconClasses = 'w-5 h-5 filament-forms-icon-button-icon';
@endphp
