...
<x-dynamic-component :component="$getFieldWrapperView()" :id="$getId()" :label="$getLabel()" :label-sr-only="$isAvatar() || $isLabelHidden()" :helper-text="$getHelperText()"
    ...
    <div x-data="fileUploadFormComponent({
        ...
        imagePreviewHeight: {{ ($previewHeight = $getImagePreviewHeight()) ? "'{$previewHeight}'" : 'null' }},
