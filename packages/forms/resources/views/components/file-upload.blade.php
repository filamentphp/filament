...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field" :label-sr-only="$isLabelHidden()">
    ...
    <div ax-load
        ...
        x-data="fileUploadFormComponent({
            ...
            captionUploadedFileUsing: async (fileKey, caption) => {
                return await $wire.captionUploadedFile(@js($statePath), fileKey, caption)
            },
        ...
        @if ($hasImageEditor && !$isDisabled)
            <div class="fixed inset-0 isolate z-50 h-screen w-screen p-2 sm:p-10 md:p-20" x-show="isEditorOpen" x-cloak
                x-on:click.stop x-trap.noscroll="isEditorOpen" x-on:keydown.escape.window="closeEditor">
                <div class="fixed inset-0 h-full w-full cursor-pointer bg-black/50" aria-hidden="true"
                    ...
                    <div
                        ...
                        <div class="w-full flex-1 overflow-auto p-4 lg:h-full">
                            <div class="h-full w-full">
                                <img class="h-full w-auto" x-ref="editor" />
                            </div>
                        </div>
        ...
        [
            ...
            'alpineSaveHandler' => 'editor.rotateTo(+$el.value)',
                                    ...
                                    <div class="flex items-center gap-3 px-4 py-3">
                                        ...
                                        <x-filament::button class="ml-auto" color="warning"
