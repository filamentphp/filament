    ...
    <textarea
        ...
        {{
            $attributes
                ...
                ->merge(
                    $getExtraInputAttributeBag()->getAttributes(),
                )
                ->class([
                    ...
                    'dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:border-primary-500' => config(
                        'forms.dark_mode',
                    ),
                    'border-gray-300' => ! $errors->has(
                        $getStatePath(),
                    ),
                    'border-danger-600 ring-danger-600' => $errors->has(
                        $getStatePath(),
                    ),
