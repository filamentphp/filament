    ...
    <textarea
        ...
        {{
            $attributes
                ...
                ->class([
                    'fi-fo-textarea block w-full rounded-lg shadow-sm outline-none transition duration-75 placeholder:text-gray-500 focus:ring-1 focus:ring-inset disabled:opacity-70 dark:bg-gray-700 dark:text-white sm:text-sm',
