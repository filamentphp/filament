            ...
            @if ($isSearchable())
                <input
                    ...
                    @class([
                        ...
                        'dark:text-gray-200 dark:bg-gray-700 dark:border-gray-600' => config(
                            'forms.dark_mode',
                        ),
                    ])
                />
                            ...
                            {{
                                $getExtraAttributeBag()
                                    ->class([
                                        ...
                                        'dark:bg-gray-700 dark:checked:bg-primary-500' => config(
                                            'forms.dark_mode',
                                        ),
                                        ...
                                        'border-danger-300 ring-danger-500' => $errors->has(
                                            $getStatePath(),
                                        ),
