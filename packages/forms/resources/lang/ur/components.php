...
return [
    ...
    'markdown_editor' => [
        ...
        'file_attachments_accepted_file_types_message' => 'صرف درج ذیل فائل اقسام کی اجازت ہے: :types',

        'file_attachments_maximum_file_size_message' => 'فائل کا سائز :size سے زیادہ نہیں ہو سکتا',
    ...
    'rich_editor' => [
                    ...
                    'form' => [
                        ...
                        'preset' => [
                            ...
                            'options' => [
                                ...
                                'four' => 'کوارٹو',
                                'five' => 'سائیں',
                                'two_start_third' => 'دو (آغاز ترço)',
                                'two_end_third' => 'دو (اختتام ترço)',
                                'two_start_fourth' => 'دو (آغاز چوتھا)',
                                'two_end_fourth' => 'دو (اختتام چوتھا)',
                            ],
                        ],
                        ...
                        'is_asymmetric' => [
                            'label' => 'غیر متقارن کالمز کی اجازت دیں',
                        ],
        ...
        'file_attachments_accepted_file_types_message' => 'صرف درج ذیل فائل اقسام کی اجازت ہے: :values',
        ...
        'uploading_file_message' => 'فائل اپلوڈ ہو رہی ہے...',
    ],
    ...
    'select' => [
        ...
        'no_options_message' => 'کوئی دستیاب آپشن نہیں۔',
