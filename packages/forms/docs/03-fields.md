...
If you find yourself in a situation where your users are required to upload files bigger than your server's capacity limit, you can use the `enableChunkUploads()` method:
