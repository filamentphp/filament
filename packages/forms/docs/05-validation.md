...
The field under validation must be less than or equal to a maximum value. [See the Laravel documentation](https://laravel.com/docs/validation#rule-max)

```php
Field::make('name')->maxValue(50)
```
