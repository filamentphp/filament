...
<AutoScreenshot name="forms/fields/color-picker/simple" alt="Color picker" version="6.x" />

Clicking the color swatch opens a color picker panel where users can visually select a color:

<AutoScreenshot name="forms/fields/color-picker/panel" alt="Color picker with panel open" version="6.x" />
...
<AutoScreenshot name="forms/fields/color-picker/formats" alt="Color pickers with different format options" version="6.x" />
