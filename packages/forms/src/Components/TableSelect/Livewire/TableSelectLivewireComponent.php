        ...
        if (filled($this->relationshipName)) {
            $table->query(function (): EloquentBuilder {
                ...
                if (
                    ...
                    $this->shouldIgnoreRelatedRecords
                ) {
                    return app(RelationshipJoiner::class)->getUnattachedQuery($relationship);
                }
                ...
                return app(RelationshipJoiner::class)->removeJoinForRelationship($relationshipQuery, $relationship);
            });
        }
