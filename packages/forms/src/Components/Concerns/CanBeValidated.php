...
trait CanBeValidated
{
    ...
    public function exists(string | Closure $table = null, string | Closure $column = null, Closure $modifyRuleUsing = null): static
    {
    ...
    public function unique(string | Closure $table = null, string | Closure $column = null, Model | Closure $ignorable = null, bool $ignoreRecord = false, Closure $modifyRuleUsing = null): static
    {
