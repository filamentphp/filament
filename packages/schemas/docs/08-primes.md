...
<AutoScreenshot name="primes/overview/example" alt="An example of using prime components to set up two-factor authentication." version="6.x" />
...
<AutoScreenshot name="primes/text/simple" alt="Text" version="6.x" />
...
<AutoScreenshot name="primes/text/html" alt="Text with HTML" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `make()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `color()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/text/color" alt="Text in the info color" version="6.x" />
...
<AutoScreenshot name="primes/text/neutral" alt="Text in the neutral color" version="6.x" />
...
<AutoScreenshot name="primes/text/badge" alt="Text as badge" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `badge()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>
...
<AutoScreenshot name="primes/text/badge-icon" alt="Text as badge with an icon" version="6.x" />
...
<AutoScreenshot name="primes/text/large" alt="Text entry in a large font size" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `weight()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/text/bold" alt="Text entry in a bold font" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `fontFamily()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/text/mono" alt="Text entry in a monospaced font" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `tooltip()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/text/tooltip" alt="Text with a tooltip" version="6.x" />
...
<AutoScreenshot name="primes/icon/simple" alt="Icon" version="6.x" />
...
<AutoScreenshot name="primes/icon/color" alt="Icon in the danger color" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `size()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/icon/sizes" alt="Icons rendered at every available size for comparison" version="6.x" />
...
<AutoScreenshot name="primes/icon/tooltip" alt="Icon with a tooltip" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static values, the arguments of the `make()` method also accept functions to dynamically calculate them. You can inject various utilities into the functions as parameters.</UtilityInjection>

<AutoScreenshot name="primes/image/simple" alt="Image" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static values, the `imageWidth()`, `imageHeight()` and `imageSize()` methods also accept functions to dynamically calculate them. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/image/size" alt="Image with a custom size" version="6.x" />
...
<UtilityInjection set="schemaComponents" version="6.x">As well as allowing a static value, the `alignment()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.</UtilityInjection>

<AutoScreenshot name="primes/image/alignment" alt="Image with a custom alignment" version="6.x" />
...
<AutoScreenshot name="primes/image/tooltip" alt="Image with a tooltip" version="6.x" />
...
<AutoScreenshot name="primes/unordered-list/simple" alt="Unordered list" version="6.x" />
...
<AutoScreenshot name="primes/unordered-list/large" alt="Unordered list with large bullets" version="6.x" />
