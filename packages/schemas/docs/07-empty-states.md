...
<AutoScreenshot name="schemas/layout/empty-state/simple" alt="Empty state" version="6.x" />
...
<AutoScreenshot name="schemas/layout/empty-state/contained-false" alt="Empty state without container" version="6.x" />
