<div x-data="{ open: {{ $isOpen ? 'true' : 'false' }} }" class="fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
    <div  
        x-show="open" 
