<x-filament::form submit="register">
    ...
    <x-filament::input-group field="password" for="password" :label="__('New Password')" required>   
    ...
    <x-filament::input-group field="password_confirmation" for="password_confirmation" :label="__('Confirm New Password')" required>   
