<div @click.away="open = false" class="relative" x-data="{ open: false }">
    ...
    <div x-show="open" 
        ...
        <div class="rounded-md bg-white shadow-xs">
            ...
            <div class="py-1">
                <a href="{{ route('filament.admin.users.edit', ['user' => auth()->user()->id]) }}" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">{{ __('filament::admin.account_settings') }}</a>
            </div>
            <div class="border-t border-gray-100"></div>
            <div class="py-1">
