...
<AutoScreenshot name="panels/navigation/user-menu" alt="User menu with custom menu item" version="6.x" />
...
<AutoScreenshot name="panels/navigation/user-menu-grouping" alt="User menu items split into separate groups" version="6.x" />
...
<AutoScreenshot name="panels/navigation/user-menu-sidebar" alt="User menu moved to the sidebar" version="6.x" />
