...
<AutoScreenshot name="panels/cluster" alt="A cluster page with sub-navigation" version="6.x" />
...
<AutoScreenshot name="panels/cluster-end" alt="Cluster with end sub-navigation position" version="6.x" />

The `SubNavigationPosition::Top` option renders the sub-navigation as tabs above the page content:

<AutoScreenshot name="panels/cluster-top" alt="Cluster with top sub-navigation position" version="6.x" />
