...
<Aside variant="tip">
    To celebrate the launch of Blueprint, we're offering a **20% discount** on all Blueprint licenses using the code `BPLAUNCH20` at [checkout](https://packages.filamentphp.com/p/blueprint/buy).
</Aside>

Blueprint is compatible with Filament v4 and above.

Once you have [purchased a license for Blueprint](https://packages.filamentphp.com/p/blueprint/buy), install it via Composer:
...
- Record and track payments The plan should:
