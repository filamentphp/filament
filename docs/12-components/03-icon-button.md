...
<AutoScreenshot name="components/icon-button/simple" alt="Icon buttons" version="6.x" />
...
<AutoScreenshot name="components/icon-button/sizes" alt="Icon buttons in different sizes" version="6.x" />
...
<AutoScreenshot name="components/icon-button/colors" alt="Icon buttons in different colors" version="6.x" />
...
<AutoScreenshot name="components/icon-button/badge" alt="Icon buttons with badges" version="6.x" />
