...
<AutoScreenshot name="components/modal/simple" alt="A modal with heading, description and footer actions" version="6.x" />
...
<AutoScreenshot name="components/modal/heading" alt="A modal with heading and description" version="6.x" />
...
<AutoScreenshot name="components/modal/icon" alt="A modal with a danger icon" version="6.x" />
...
<AutoScreenshot name="components/modal/footer" alt="A modal with a custom footer" version="6.x" />
...
<AutoScreenshot name="components/modal/alignment" alt="A modal with center-aligned content" version="6.x" />
...
<AutoScreenshot name="components/modal/slide-over" alt="A slide-over modal" version="6.x" />
...
<AutoScreenshot name="components/modal/sticky-header" alt="A modal with a sticky header" version="6.x" />
...
<AutoScreenshot name="components/modal/sticky-footer" alt="A modal with a sticky footer" version="6.x" />
...
<AutoScreenshot name="components/modal/width" alt="A modal with a custom width" version="6.x" />
