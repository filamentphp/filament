...
<AutoScreenshot name="components/input/disabled" alt="A disabled input" version="6.x" />
...
<AutoScreenshot name="components/input/prefix" alt="An input with a prefix" version="6.x" />
...
<AutoScreenshot name="components/input/icon" alt="An input with a prefix icon" version="6.x" />
...
<AutoScreenshot name="components/input/suffix-icon-color" alt="An input with a colored suffix icon" version="6.x" />
