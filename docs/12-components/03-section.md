...
<AutoScreenshot name="components/section/simple" alt="A simple section" version="6.x" />
...
<AutoScreenshot name="components/section/description" alt="A section with a description and icon" version="6.x" />
...
<AutoScreenshot name="components/section/icon" alt="A section with an icon" version="6.x" />
...
<AutoScreenshot name="components/section/icon-color" alt="A section with a colored icon" version="6.x" />
...
<AutoScreenshot name="components/section/icon-sizes" alt="Sections with different icon sizes" version="6.x" />
...
<AutoScreenshot name="components/section/after-header" alt="A section with content after the header" version="6.x" />
...
<AutoScreenshot name="components/section/collapsible" alt="A collapsible section" version="6.x" />
...
<AutoScreenshot name="components/section/collapsed" alt="A collapsed section" version="6.x" />
...
<AutoScreenshot name="components/section/aside" alt="A section with the header aside the content" version="6.x" />
...
<AutoScreenshot name="components/section/content-before" alt="A section with content before the header" version="6.x" />
