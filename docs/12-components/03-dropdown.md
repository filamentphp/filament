...
<AutoScreenshot name="components/dropdown/simple" alt="A dropdown menu with action items" version="6.x" />
...
<AutoScreenshot name="components/dropdown/colors" alt="Dropdown items in different colors" version="6.x" />
...
<AutoScreenshot name="components/dropdown/icons" alt="Dropdown items with icons" version="6.x" />
...
<AutoScreenshot name="components/dropdown/icon-colors" alt="Dropdown items with different icon colors" version="6.x" />
...
<AutoScreenshot name="components/dropdown/image" alt="Dropdown items with images" version="6.x" />
...
<AutoScreenshot name="components/dropdown/badge" alt="Dropdown items with badges" version="6.x" />
...
<AutoScreenshot name="components/dropdown/width" alt="A dropdown with a custom width" version="6.x" />
...
<AutoScreenshot name="components/dropdown/max-height" alt="A dropdown with a maximum height" version="6.x" />
